...
<boxed-text>
  ...
  <back>
    ...
    <ref-list>
      ...
      <ref id="B9">
        <label>9</label>
        <mixed-citation publication-type="webpage" publication-format="web">General Medical Council. <source>Draft recommendations on undergraduate medical education</source>. July 2001. www.gmc-uk.org/med_ed/tomorrowsdoctors/index.htm (accessed 2 Jan 2002).</mixed-citation>
      </ref>
      <ref id="B10">
        <label>10</label>
        <element-citation publication-type="book" publication-format="print">
    ...
    <fn-group>
      <fn id="fn1">
        <p>Funding: Meetings of the working group in 1999-2000 were funded
        by the <funding-source>Scientific Foundation Board of the RCGP</funding-source>.</p>
      </fn>
      <fn id="fn2">
